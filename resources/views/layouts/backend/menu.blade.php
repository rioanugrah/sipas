...
<div class="menu-item">
    <div class="menu-content pt-8 pb-2">
        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Master Surat</span>
    </div>
</div>
<div class="menu-item">
    <a class="menu-link {{ Request::is('b/surat_masuk*') ? 'active' : '' }}" href="{{ route('surat_masuk') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
...
<div class="menu-item">
    <a class="menu-link {{ Request::is('b/surat_keluar*') ? 'active' : '' }}" href="{{ route('surat_keluar') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
...
<div class="menu-item">
    <div class="menu-content pt-8 pb-2">
        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Disposisi</span>
    </div>
</div>
<div class="menu-item">
    <a class="menu-link {{ Request::is('b/surat_masuk*' ? 'active' : '') }}" href="{{ route('surat_masuk') }}">
        ...
        <span class="menu-title">Disposisi Masuk</span>
    </a>
</div>
<div class="menu-item">
    <a class="menu-link {{ Request::is('b/surat_keluar*' ? 'active' : '') }}" href="{{ route('surat_keluar') }}">
        ...
        <span class="menu-title">Disposisi Keluar</span>
    </a>
</div>
<div class="menu-item">
    <div class="menu-content pt-8 pb-2">
...
<div class="menu-item">
    <a class="menu-link {{ Request::is('b/surat_keluar*' ? 'active' : '') }}" href="{{ route('surat_keluar') }}">
        ...
        <span class="menu-title">Data Klasifikasi</span>
    </a>
</div>
<div class="menu-item">
    <a class="menu-link {{ Request::is('b/surat_keluar*' ? 'active' : '') }}" href="{{ route('surat_keluar') }}">
...
<div class="menu-item">
    <a class="menu-link {{ Request::is('b/pengguna*') ? 'active' : '' }}" href="{{ route('users') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path
...
<div class="menu-item">
    <div class="menu-content pt-8 pb-2">
        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Versi App</span>
    </div>
</div>
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
            ...
            <div class="menu-sub menu-sub-accordion menu-active-bg">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="../../demo8/dist/authentication/email/password-reset.html"
                        target="blank">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="../../demo8/dist/authentication/email/password-change.html"
                        target="blank">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
...
<div class="menu-item">
    <div class="menu-link">
        ...
        <span class="menu-title">Versi v2.0.1</span>
    </div>
</div>
