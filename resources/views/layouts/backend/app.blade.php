                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <td>
                                                                        <div class="symbol symbol-45px me-2">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ $link }}/assets/media/svg/brand-logos/plurk.svg"
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="symbol symbol-45px me-2">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ $link }}/assets/media/svg/brand-logos/telegram.svg"
                                                                                    class="h-50 align-self-center"
                                                                                    alt="" />
                                                                            </span>
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="symbol symbol-45px me-2">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ $link }}/assets/media/svg/brand-logos/vimeo.svg"
                                                                                    class="h-50 align-self-center"
                                                                                    alt="" />
                                                                            </span>
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="symbol symbol-45px me-2">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ $link }}/assets/media/svg/brand-logos/bebo.svg"
                                                                                    class="h-50 align-self-center"
                                                                                    alt="" />
                                                                            </span>
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="symbol symbol-45px me-2">
                                                                            <span class="symbol-label">
                                                                                <img src="{{ $link }}/assets/media/svg/brand-logos/kickstarter.svg"
                                                                                    class="h-50 align-self-center"
                                                                                    alt="" />
                                                                            </span>
                                                                        </div>
                                    ...
                                    <div class="card card-xl-stretch mb-xl-8">
                                        ...
                                        <div class="card-body pt-3">
                                            ...
                                            <div class="d-flex align-items-sm-center mb-7">
                                                ...
                                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('{{ $link }}/assets/media/stock/600x400/img-20.jpg')">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-sm-center mb-7">
                                                ...
                                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('{{ $link }}/assets/media/stock/600x400/img-19.jpg')">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-sm-center mb-7">
                                                ...
                                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('{{ $link }}/assets/media/stock/600x400/img-25.jpg')">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-sm-center">
                                                ...
                                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                                    <div class="symbol-label"
                                                        style="background-image: url('{{ $link }}/assets/media/stock/600x400/img-24.jpg')">
                                                    </div>
                                                </div>
