    ...
    <div class="container-fluid">
        <div class="navbar-left">
            <div class="navbar-btn">
                <a href="{{ route('home') }}"><img src="{{ $link }}/assets/images/icon.svg" alt="Mooli Logo" class="img-fluid logo"></a>
                ...
                <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu right_chat email mt-0 animation-li-delay">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{ $link }}/assets/images/xs/avatar4.jpg" alt="">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object" src="{{ $link }}/assets/images/xs/avatar1.jpg" alt="">
                                        <div class="media-body">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object" src="{{ $link }}/assets/images/xs/avatar5.jpg" alt="">
                                        <div class="media-body">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media mb-0">
                                        <img class="media-object" src="{{ $link }}/assets/images/xs/avatar2.jpg" alt="">
                                        <div class="media-body">
                    ...
                    <li class="dropdown language-menu hidden-xs">
                        ...
                        <div class="dropdown-menu language_widget mt-0">
                            <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ $link }}/assets/images/flag/us.svg" alt="US English" > US English</a>
                            <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ $link }}/assets/images/flag/gb.svg" alt="UK English" > UK English</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ $link }}/assets/images/flag/russia.svg" alt="Russian" > Russian</a>
                            <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ $link }}/assets/images/flag/arabia.svg" alt="Arabic" > Arabic</a>
                            <a class="dropdown-item pt-2 pb-2" href="javascript:void(0);"><img src="{{ $link }}/assets/images/flag/france.svg" alt="French" > French</a>
                        </div>
                    </li>
