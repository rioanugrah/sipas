<div id="left-sidebar" class="sidebar">
    ...
    <div class="sidebar-scroll">
        <div class="user-account">
            <img src="{{ $link }}/images/user.png" class="rounded-circle user-photo" alt="User Profile Picture">
            <div class="dropdown">
                <span>Welcome,</span>
        ...
        <div class="tab-content padding-0">
            <div class="tab-pane active" id="menu">
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    @include('layouts.backend_2.menu')
                </nav>
            </div>
                ...
                <ul class="right_chat list-unstyled li_animation_delay">
                    <li>
                        <a href="javascript:void(0);" class="media">
                            <img class="media-object" src="{{ $link }}/images/xs/avatar1.jpg" alt="">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="media">
                            <img class="media-object" src="{{ $link }}/images/xs/avatar2.jpg" alt="">
                            <div class="media-body">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="media">
                            <img class="media-object" src="{{ $link }}/images/xs/avatar3.jpg" alt="">
                            <div class="media-body">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="media">
                            <img class="media-object" src="{{ $link }}/images/xs/avatar4.jpg" alt="">
                            <div class="media-body">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="media">
                            <img class="media-object" src="{{ $link }}/images/xs/avatar5.jpg" alt="">
                            <div class="media-body">
