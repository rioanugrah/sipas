<ul id="main-menu" class="metismenu li_animation_delay">
    ...
    <li>
        ...
        <ul>
            ...
            <li class="menu-link {{ Request::is('b/surat_keluar*') ? 'active' : '' }}"><a href="{{ route('surat_keluar') }}">Surat Keluar</a></li>
        </ul>
    </li>
    <li>
        <a href="javascript:void()" class="has-arrow"><i class="fa fa-envelope-o"></i><span>Disposisi</span></a>
        <ul>
            <li class="menu-link {{ Request::is('b/disposisi_masuk*') ? 'active' : '' }}"><a href="#">Disposisi Masuk</a></li>
            <li class="menu-link {{ Request::is('b/disposisi_keluar*') ? 'active' : '' }}"><a href="#">Disposisi Keluar</a></li>
        </ul>
    </li>
    <li>
        <a href="javascript:void()" class="has-arrow"><i class="fa fa-gears"></i><span>User Management</span></a>
        <ul>
            <li class="menu-link {{ Request::is('b/disposisi_masuk*') ? 'active' : '' }}"><a href="#">Roles</a></li>
            <li class="menu-link {{ Request::is('b/disposisi_keluar*') ? 'active' : '' }}"><a href="{{ route('users') }}">Users</a></li>
        </ul>
    </li>
    {{-- <li>
